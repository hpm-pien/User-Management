 ...
 * @author Admin
 */
public class ViewUserPromotionServlet extends HttpServlet {
 private final String ADDUSER_PAGE = "viewUserPromotion.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("Error at view User Promotion Servlet: " + e.toString());
        }finally{
